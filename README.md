...
Tables Go to [db.lewagon.com](db.lewagon.com) and draw the schema. The tables we need. Think about the relations between the tables and what fields should be in each table.
